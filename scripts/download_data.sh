...
kaggle competitions download -c expedia-hotel-recommendations -p data/raw/

cd data/raw && unzip -o expedia-hotel-recommendations.zip && rm expedia-hotel-recommendations.zip
